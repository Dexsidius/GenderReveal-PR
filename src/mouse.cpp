...
void MouseManager::Process(){
    // clicking checks to see if the mouse in process of clicking something. 
    ...
    // has clicked checks to see if the mouse has clicked, but not currently clicking something
    has_clicked = clicking && !clicking;
    
    // clicked is set to the last state of the mouse, reset every frame
    clicked = clicking;

    // make sure the middle of the rectangle represents the mouse
